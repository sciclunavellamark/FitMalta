  ...
  return (
    <div className="bg-background py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">Create Meal Plan</h1>
          <p className="text-muted-foreground">Share your nutrition expertise with the community</p>
        </div>
